...
public class ListOfTrainings {
	...
	public ListOfTrainings(String course_id, String course_title, int status, String date, int dateNumber,
			String dayName, String startTime, String endTime, String instructor, String description, int training_id, String month) {
		super();
		this.course_id = course_id;
