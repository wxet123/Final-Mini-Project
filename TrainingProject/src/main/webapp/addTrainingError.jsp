...
<body>
	...
	%>
			...
			<script>
			Swal.fire({
				title: 'Conflict in registering schedule', 
				text: 'See training schedule and try again', 
				icon: 'error' ,   
				button: 'Retry'
			});
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form method="post"
						...
						<div class="input-group mb-3">
							...
							<table>
								...
								<td style="margin-top : 10px; ">
									<div class="col-md-2">
										<select style = "width : 120px "  name="course_title" id="sub_menu2"
											class="custom-select">
						...
						<br> <input type="hidden" name="instructor" value="<c:out value="${username}"/>">
