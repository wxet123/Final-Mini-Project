							...
							<c:forEach items="${listAll}" var="u" varStatus = "loop" >
                                    ...
                                    <div class="accordion-item">
                                      ...
                                      <div id="collapse<c:out   value="${loop.count}" />"
                                        ...
                                        <div class = "wrapper">
                                      	  <div class="grid">
                                        	  <h5><strong>  <i class="fas fa-calendar-alt"></i> ${u.getDayName()}  - ${u.getMonth()} ${u.getDateNumber()},      ${u.getStartTime()} - ${u.getEndTime()} </strong></h5> 
                                        	...
                                        	<c:if test="${empty listAll}">
													<div class="noDATA" >
														<br> <br>
														<h3 class="errorTitle">No new trainings scheduled</h3>
